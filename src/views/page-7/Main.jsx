      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        <div className="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
          <div className="flex w-full sm:w-auto">
            <button className="btn btn-primary shadow-md mr-2">Add New Quote</button>
          ...
          <table className="table table-report -mt-2">
            <thead>
              <tr>
                ...
                <th className="whitespace-nowrap">CREATION</th>
                <th className="text-right whitespace-nowrap">
                  <div className="pr-16">TOTAL PRICE</div>
                </th>
              ...
              {$_.take($f(), 9).map((faker, fakerKey) => (
                <tr key={fakerKey} className="intro-x">
                  ...
                  <td className="w-40 !py-4">
                    <a
                      href="/side-menu/quote-view"
                      className="underline decoration-dotted whitespace-nowrap"
                    >
                      {"#QUO-" + faker.totals[0] + "807556"}
                    </a>
                  </td>
                  <td className="w-40">
                    {faker.trueFalse[0] ? (
                      <a href="/side-menu/customer-view" className="font-medium whitespace-nowrap">{faker.users[0].name}</a>
                    ) : (
                      <a href="/side-menu/customer-view" className="font-medium whitespace-nowrap">{faker.users[0].name}</a>
                    )}
                  </td>
                    ...
                    >
                      {faker.trueFalse[0] ? (
                        <div className="flex items-center justify-center">
                          <Lucide icon="CheckSquare" className="w-4 h-4 mr-1" />Signed
                        </div>
                      ) : (
                        <div className="flex items-center justify-center">
                          <Lucide icon="X" className="w-4 h-4 mr-1" />Non Signed
                        </div>
                      )}
                    </div>
                  </td>
